...
for m in "$ROOT"/migrations/20260925000001_init.sql "$ROOT"/migrations/20260926000003_app.sql "$ROOT"/migrations/20260926000004_hardening.sql "$ROOT"/migrations/20260926000005_admin.sql "$ROOT"/migrations/20260926000006_email_auth.sql "$ROOT"/migrations/20260926000007_drop_waitlist.sql "$ROOT"/migrations/20260926000008_session_fingerprint.sql; do "${PSQL[@]}" -f "$m"; done
